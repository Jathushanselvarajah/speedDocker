...
var base_speed = 170.0
var speed_increase = 5.0
var pixels_per_km = 130.0
...
func _ready():
	...
	start_timer.wait_time = 5.0  # Assurez-vous que le timer est défini
...
func _process(delta):
	...
	base_speed = 170.0 + speed_increase * int(max_distance_km / 10)
